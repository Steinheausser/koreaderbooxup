...
import org.koreader.launcher.device.epd.OnyxPenBridge
...
class MainActivity : NativeActivity(), LuaInterface,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize Onyx low-latency stylus bridge
        OnyxPenBridge.init(this)
    ...
    override fun booxSetDrawingMode(enabled: Boolean, excludeRectsJson: String) {
        OnyxPenBridge.setDrawingMode(this, enabled, excludeRectsJson)
    }

    override fun booxSetPenWidth(width: Float) {
        OnyxPenBridge.setPenWidth(width)
    }

    override fun booxSetPenColor(color: Int) {
        OnyxPenBridge.setPenColor(color)
    }

    override fun booxPollStrokes(): String {
        return OnyxPenBridge.pollStrokesJson()
    }

    override fun booxClearStrokes() {
        OnyxPenBridge.clearPendingStrokes()
    }
